...
export const initialProjects: Project[] = [
  {
    id: 'proj-1',
    title: 'LAKSANA (Layanan Digital Pemasyarakatan)',
    slug: 'laksana-layanan-digital-pemasyarakatan',
    short_description: 'Sistem layanan digital pemasyarakatan terpadu untuk pengawasan, integrasi data publik, dan manajemen operasional lembaga.',
    full_description: 'Aplikasi web portal Layanan Digital Pemasyarakatan (LAKSANA) yang mengintegrasikan data pelayanan publik, dashboard operasional, serta pemantauan fasilitas terpusat.',
    thumbnail_url: '/uploads/projects/projects-1786653356374.png',
    category: 'Web Application',
    technologies: ['Laravel', 'PHP', 'MySQL', 'JavaScript', 'Tailwind CSS'],
    project_year: '2024',
    live_url: 'https://laksana.taufikrahman.dev',
    github_url: 'https://github.com/taufikrahman29/laksana-app',
    is_featured: true,
    published: true,
    display_order: 1,
    gallery_images: [
  ...
  },
  {
    ...
    short_description: 'Aplikasi web cerdas pengelolaan data inventaris, kunjungan, dan operasional layanan publik Lapas Bekasi.',
    full_description: 'Sistem aplikasi web pintar untuk efisiensi alur informasi, pelaporan insiden, rekap kebersihan & fasilitas umum di lingkungan Lapas Bekasi.',
    thumbnail_url: '/uploads/projects/projects-1786653518124.png',
    category: 'Aplikasi Web',
    technologies: ['Laravel', 'React', 'Tailwind CSS', 'MySQL'],
    project_year: '2025',
    live_url: 'https://smartlapas.taufikrahman.dev',
    github_url: 'https://github.com/taufikrahman29/smart-lapas-bekasi',
    is_featured: false,
    published: true,
    display_order: 4,
    gallery_images: [
